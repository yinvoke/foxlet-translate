...
class BenchRunner(
    ...
    /** Records auto-thread recommendations; measurements use the explicit [foxletThreads] count. */
    ...
    suspend fun run(): JSONObject {
        ...
        if (!ready) {
            ...
            // Share one client across phases; fresh processes isolate separate benchmark runs.
            val t = foxletThreads
