...
class DeliveryTest {
    @Test fun unifiedClientDeliversTranslationAndModelManagement(): Unit = runBlocking {
        ...
        try {
            ...
            Log.i("foxlet-delivery", "prepare model started")
            val model = client.models.prepare(pair) {
                if (stages.lastOrNull() != it.stage || it.downloadedBytes - lastReportedBytes >= 5 * 1024 * 1024) {
                    Log.i("foxlet-delivery", "prepare ${it.stage} bytes=${it.downloadedBytes}/${it.totalBytes}")
                    lastReportedBytes = it.downloadedBytes
                }
                stages += it.stage
            }
            Log.i("foxlet-delivery", "model ready; starting translation and lifecycle checks")
            ...
            Log.i("foxlet-delivery", "translation and lifecycle passed; checking live model index")
            ...
            Log.i("foxlet-delivery", "delivery checks passed")
