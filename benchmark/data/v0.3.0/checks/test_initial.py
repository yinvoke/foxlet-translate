...
Run with: python3 -B <this-directory>/test_initial.py -v
...
import initial as verify


SYNTHETIC_REPORT = verify.REPORT.with_name('__synthetic_test_only__.json')
MEDIAN_FIELDS = {
    ...
    def analyze(self, raw):
        ...
        def run_checker(command, **kwargs):
            self.assertEqual(command, [
                sys.executable, str(verify.CHECK_PATH),
