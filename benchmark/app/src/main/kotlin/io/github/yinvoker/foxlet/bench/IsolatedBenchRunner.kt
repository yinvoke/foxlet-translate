...
/**
 * Per-process android-app-v1 JSON format, shared by the v1 and v2 scenario suites.
 * Measures one engine/direction with one first pass and two warm passes over
 * 200 inputs. Model downloads run separately. The host collector selects the
 * suite, restarts processes and records APK, input and device fingerprints.
 * Native harness measurements use a separate protocol.
 */
