...
> 当前为发布说明草稿。此前的 v0.4.0 标签与发布流程已撤回；新版构件须完成真机验收后再发布。v0.3.0 Release 已撤下，历史标签保留。
...
本地实现、迁移示例及验证状态分别见仓库中的 `docs/api-design-review.md`、`docs/getting-started.md` 和 `docs/benchmarking.md`。
